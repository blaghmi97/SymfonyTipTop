 ...
 */
class getRouting_LoaderService extends App_KernelPreprodDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'preprod');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'preprod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'preprod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'preprod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'preprod'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'preprod'));
